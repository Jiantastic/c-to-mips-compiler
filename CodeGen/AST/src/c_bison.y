...
postfix_expression : primary_expression                                           { $$ = new UnaryExpression($1,"primary_expression");completeTree.push_back($$);}
                   ...
                   | postfix_expression '(' ')'                                   {std::cout << "func call 1" << std::endl;}
                   | postfix_expression '(' argument_expression_list ')'           {std::cout << "func call 2" << std::endl;}
...
init_declarator : declarator                                                            {
                ...
                | declarator '=' initializer                                            {   std::cout << "am i here?" << std::endl;
                                                                                            int counter = 0;
                                                                                            int x = mips32.findEmptyRegister();
                                                                                            if(x == -1){
                                                                                              if(debugMode){
